...
class PublisherController {
    ...
    @ApiImplicitParams([
            ...
            @ApiImplicitParam(name = "publisherCommand", paramType = "body", required = true, value = "Publishers Command", dataType = "grails.plugin.swagger.grails.test.PublisherCommand")
    ])
